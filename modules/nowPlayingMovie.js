...
module.exports = getNowPlayingMovieData;


function getNowPlayingMovieData(req, res) {

  let url = `https://api.themoviedb.org/3/movie/now_playing?api_key=3364da0f5f06ed4e038dcad748f160ca&language=en-US&page=1`;
